...
#fileName <- "data/tae.data"                 # Mixed attributes   

#fileName <- "data/diagnosis.data"             # Mixed attributes     

# fileName <-  "data/abalone.data"     # 29 classes   
...
# ########  ( OLD ) Parameters and Pre-processing step  #########
